...
//     .min(8, "Password must be more than 8 characters")
//     .max(32, "Password must be less than 32 characters"),
//   // Optional field for the requested role
//   requestedRole: z.enum(["RADIOLOGIST", "HOSPITAL"]).optional(),
// });

// async function sendVerificationEmail(email: string, token: string, userData: { username: string, password: string, requestedRole?: string }) {
//   const baseUrl = process.env.NEXTAUTH_URL || 'http://localhost:3000';
//   // Store user data in the token query params (encrypted as JSON)
//   const userDataParam = Buffer.from(JSON.stringify(userData)).toString('base64');
...
//           </tr>
//           <tr>
//             <td align="center" style="padding: 0px 0px 10px 0px; font-size: 14px; line-height: 22px; font-family: Helvetica, Arial, sans-serif; color: #666666;">
//               Note: After email verification, an administrator will need to approve your account before you can access the system.
//             </td>
//           </tr>
//         </table>
//       </body>
...
// async function sendAdminNotificationEmail(newUserEmail: string, requestedRole: string) {
...
//     text: `A new user (${newUserEmail}) has signed up and requested the role: ${requestedRole}. Please review and approve at ${approvalUrl}`,
//     html: `
//       <body style="background: #f9f9f9;">
//         <table width="100%" border="0" cellspacing="20" cellpadding="0" style="background: #ffffff; max-width: 600px; margin: auto; border-radius: 10px;">
//           <tr>
...
//   try {
//     const body = await req.json();
//     const { username, email, password, requestedRole = "HOSPITAL" } = signInSchema.parse(body);
...
//     return NextResponse.json(
//       { message: "Verification email sent. Please check your inbox to complete registration. After verification, an administrator will need to approve your account." },
//       { status: 200 }
//     );
//   } catch (error) {
//     console.error("Signup error:", error);
